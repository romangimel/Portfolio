# Focused Hero visual regression tests

These Playwright screenshots protect the currently approved homepage surfaces:
...
The mobile screenshots deliberately target `.hero__layout`, which starts after the current narrow Header. The unfinished mobile Header and navigation are therefore not part of these baselines.
